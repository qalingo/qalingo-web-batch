...
public class CmsContentItemProcessor<T> implements ItemProcessor<CommonProcessIndicatorItemWrapper<CmsContent, CmsContent>, CmsContent>, InitializingBean {
	 ...
	 */
	public CmsContent process(CommonProcessIndicatorItemWrapper<CmsContent, CmsContent> wrapper) throws Exception {

		CmsContent sourceCmsContent = wrapper.getItem();
			
		return sourceCmsContent;
	}
